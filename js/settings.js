...
categories.forEach(category => {
    category.addEventListener("click", () => {
        ...
        if(type === "theme") {
            ...
            const appman = document.querySelector("[view='appman']");
            views.forEach(view => {
                view.setAttribute("hiddenCat", "true");
            })
            appman.setAttribute("hiddenCat", "false");
        } else if(type === "account") {
            const account = document.querySelector("[view='account']");
            views.forEach(view => {
                view.setAttribute("hiddenCat", "true");
            })
            account.setAttribute("hiddenCat", "false");
        }
    })
});
